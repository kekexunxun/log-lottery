...
export const defaultCurrentPrize = <IPrizeConfig>{
  ...
  count: 12,
  isUsedCount: 0,
  picture: { id: '2', name: '三等奖', url: `${originUrl}/resource/image/image3.png` },
  separateCount: {
    enable: true,
    countList: []
  },
...
export const defaultPatternList = [
  21, 38, 55, 54, 53, 70, 87, 88, 89, 23, 40, 57, 74, 91, 92, 93, 76, 59, 42, 25, 24, 27, 28, 29, 46, 63, 62, 61, 78,
  95, 96, 97, 20, 19, 31, 48, 65, 66, 67, 84, 101, 100, 99, 32, 33
]
